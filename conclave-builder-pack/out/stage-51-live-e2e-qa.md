...
- dashboard live URL: **미배포 → Stage 53 참조** (`stage-53-dashboard-vercel-deployment.md`). target `https://dashboard.conclave-ai.dev`(코드 pre-wired, DNS 미설정). 코드 fallback은 위 worker.
